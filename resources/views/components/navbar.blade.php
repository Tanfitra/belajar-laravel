                      ...
                      <div class="relative ml-3">
                          ...
                          <div x-show="isOpen"
                              ...
                              <form method="POST" action="{{ route('logout') }}">
                                  @csrf
                                  <button type="submit" class="block w-full px-4 py-2 text-sm text-gray-700 text-left" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                              </form>
                          </div>
                      </div>
                  @else
      ...
      @auth
          <div class="border-t border-gray-700 pt-4 pb-3">
              ...
              <div class="mt-3 space-y-1 px-2">
                  ...
                  <form method="POST" action="{{ route('logout') }}">
                      @csrf
                      <button type="submit" class="block w-full px-3 py-2 text-base font-medium text-gray-400 text-left hover:bg-gray-700 hover:text-white">Sign out</button>
                  </form>
              </div>
          </div>
      @endauth
